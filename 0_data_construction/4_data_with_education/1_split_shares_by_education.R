...
load("../3_census_data/data/census_2013.Rdata")  # → census_shares_2013
load("../3_census_data/data/census_2017.Rdata")  # → census_shares_2017
load("../3_census_data/data/census_2021.Rdata")  # → census_shares_2021
...
save(census_2021_edu, file = "data/census_2021_edu.Rdata")
...
save(census_2017_edu, file = "data/census_2017_edu.Rdata")
...
save(census_2013_edu, file = "data/census_2013_edu.Rdata")
