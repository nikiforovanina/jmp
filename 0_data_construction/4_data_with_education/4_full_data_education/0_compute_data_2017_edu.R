# =========================================================
# Build results_std / pos_std for ALL states (1..16) in 2017
# Uses education-split census shares (census_2017_edu.Rdata)
# =========================================================
...
# Per-mode output directory (see 0_compute_data_2021_edu.R for explanation).
.cand_mode <- Sys.getenv("CAND_SCORE_MODE", unset = "pooled")
.out_dir   <- sprintf("data_%s", .cand_mode)
dir.create(.out_dir, showWarnings = FALSE, recursive = TRUE)
message(sprintf(">>> [edu 2017] writing to %s/", .out_dir))
...
# =========================================================
load("../data/census_2017_edu.Rdata")   # → census_2017_edu
census <- census_2017_edu
...
# =========================================================
load("../../2_cand_survey_full_data_wen_waehlen/data/cand17_scored_full_shrunk.Rdata")
