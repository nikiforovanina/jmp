...
message(sprintf(">>> [edu 2013] writing to %s/", .out_dir))
...
# =========================================================
load("../data/census_2013_edu.Rdata")   # → census_2013_edu
...
# =========================================================
load("../../2_cand_survey_full_data_wen_waehlen/data/cand13_scored_full_shrunk.Rdata")
...
# One-state builder
# =========================================================
build_state_2013 <- function(STATE_ID, out_dir = .out_dir) {
