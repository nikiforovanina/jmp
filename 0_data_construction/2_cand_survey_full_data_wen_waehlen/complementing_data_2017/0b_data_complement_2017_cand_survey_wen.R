...
# 1) Read cand17 + LUT
#----------------------------
cand17 <- haven::read_dta("../../1_cand_scores_GESIS/candidates_2017.dta")
...
# Persist for downstream 1_imputing_positions_2017.R
save(wen_merged, file = "wen_merged_2017.Rdata")
