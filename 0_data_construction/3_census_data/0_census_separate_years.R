...
norm_age <- function(x) {
  x <- str_trim(x)
  x <- str_replace_all(x, stringr::fixed(" Jahre"), "")
  x <- str_replace_all(x, stringr::fixed("Unter "), "0-")
  x <- str_replace_all(x, " bis ", "-")
  x <- str_replace_all(x, stringr::fixed(" und älter"), "+")
...
save(census_shares_2021, file = "data/census_2021.Rdata")
save(census_shares_2013, file = "data/census_2013.Rdata")
save(census_shares_2017, file = "data/census_2017.Rdata")
