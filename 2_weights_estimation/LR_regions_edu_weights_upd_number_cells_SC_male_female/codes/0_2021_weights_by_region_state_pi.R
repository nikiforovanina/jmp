...
#
# Usage:
#   Rscript 0_2021_weights_by_region_state_pi.R --region east
#   Rscript 0_2021_weights_by_region_state_pi.R --region west
# ===============================================================
...
if (!length(region_arg_pos) || length(args) < region_arg_pos + 1) {
  stop("Usage: Rscript 0_2021_weights_by_region_state_pi.R --region east|west")
}
