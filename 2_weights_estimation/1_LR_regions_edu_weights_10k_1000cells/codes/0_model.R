...
#   AFD_GROUP_TOL, SC_TOL, EDU_DIFF_TOL, ABS_EPS, REL_EPS
#   SMALL_MUNI_MAX_ELIGIBLE, MIN_ROWS_PER_ELECTION
#   VOR_PAD, KEEP_TOP_N_CELLS, SC_PARTIES, W2_GRID, LAMBDA_CELLS
#   W1_FIXED
#   get_age_gender_targets(), get_age_gender_turnout()
#     (sourced by the runner from year-specific RW_<YEAR>_*.R files)
# ===============================================================
