...
# =========================================================
load("../output_data/census_2021.Rdata")  # provides census_shares_only
...
# =========================================================
load("../output_data/cand21_scored_full_shrunk.Rdata")      

cand21_scored_full_shrunk <- cand21_scored_full_shrunk %>% group_by(wknr) %>% mutate(n_wknr = n()) %>% ungroup()
cand21_scored_full_shrunk <- cand21_scored_full_shrunk %>% filter(n_wknr > 3)
cand21_scored_full_shrunk$n_wknr <- NULL
...
message("\nDone for 2021 with improved candidate handling (WK -> state -> national fallbacks).")
