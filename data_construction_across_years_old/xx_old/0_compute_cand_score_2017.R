...
cand17_scored <- cand17 %>%
  ...
  left_join(scores_2017 %>% select(wknr, a1_or_partei, econ_lr_score, anti_elite_score, party_id),
...
ggsave("graphs_data/plot_can_2017_LR.png", cand17_scored_plot, width = 7, height = 5, dpi = 300)

cand17_scored <- cand17_scored[c('partei', 'wknr', 'econ_lr_score', 'anti_elite_score')]
